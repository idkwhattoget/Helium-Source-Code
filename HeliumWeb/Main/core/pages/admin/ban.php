...
<center><h1>banning</h1>
<h2><b>do not ban yourself i will not revoke your ban</b></h2>
  <form method="post" action="/app/admin/doban"> 
    <input type="text" name="usertoban" required placeholder="the name of the person u wanna ban"><br>
